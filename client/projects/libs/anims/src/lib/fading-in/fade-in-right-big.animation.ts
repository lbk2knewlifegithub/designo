...
export interface IFadeInRightBigAnimationOptions extends AnimationOptions {
  /**
...
export function fadeInRightBigAnimation(
  options?: IFadeInRightBigAnimationOptions
): AnimationTriggerMetadata {
...
export function fadeInRightBigOnEnterAnimation(
  options?: IFadeInRightBigAnimationOptions
): AnimationTriggerMetadata {
