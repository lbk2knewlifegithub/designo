...
export interface IFadeOutRightAnimationOptions extends AnimationOptions {
  /**
...
export function fadeOutRightAnimation(
  options?: IFadeOutRightAnimationOptions
): AnimationTriggerMetadata {
...
export function fadeOutRightOnLeaveAnimation(
  options?: IFadeOutRightAnimationOptions
): AnimationTriggerMetadata {
