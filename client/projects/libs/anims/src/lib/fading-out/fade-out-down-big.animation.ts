...
export interface IFadeOutDownBigAnimationOptions extends AnimationOptions {
  /**
...
export function fadeOutDownBigAnimation(
  options?: IFadeOutDownBigAnimationOptions
): AnimationTriggerMetadata {
  return trigger((options && options.anchor) || 'fadeOutDownBig', [
    transition(
      '0 => 1',
      [...useAnimationIncludingChildren(fadeOutDownBig(), options)],
      {
        params: {
...
export function fadeOutDownBigOnLeaveAnimation(
  options?: IFadeOutDownBigAnimationOptions
): AnimationTriggerMetadata {
