...
export const categoriesPreview: CategoryPreview[] = [
  {
    name: 'headphones',
    image: {
      mobile:
        './assets/product-xx99-mark-one-headphones/mobile/image-removebg-preview.png',
      tablet:
        './assets/product-xx99-mark-one-headphones/tablet/image-removebg-preview.png',
      desktop:
        './assets/product-xx99-mark-one-headphones/desktop/image-removebg-preview.png',
    },
  },

  {
    name: 'speakers',
    image: {
      mobile: './assets/product-zx9-speaker/mobile/image-removebg-preview.png',
      tablet: './assets/product-zx9-speaker/tablet/image-removebg-preview.png',
      desktop:
        './assets/product-zx9-speaker/desktop/image-removebg-preview.png',
    },
  },
  {
    name: 'earphones',
    image: {
      mobile:
        './assets/product-yx1-earphones/mobile/image-removebg-preview.png',
      tablet:
        './assets/product-yx1-earphones/tablet/image-removebg-preview.png',
      desktop:
        './assets/product-yx1-earphones/desktop/image-removebg-preview.png',
    },
  },
];
